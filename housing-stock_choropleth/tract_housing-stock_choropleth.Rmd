...
```{r}
tracts_df <- read_sf("SHP/SHP_chicago-tracts_housing-stock/acs2021_5yr_B25024_14000US17031010502.shp", quiet = TRUE)
```
...
rayshader_housing_units <- ggplot(tracts_average_units, aes(fill = average_units)) +
  geom_sf(color = NA) +
...
render_highquality(
  filename = here("housing-stock_choropleth", "plots", "raytrace_test_10.png"),
  width = 1200,
  height = 1200,
  samples = 1200,
  interactive = FALSE,
...
render_highquality(
  ground_material = diffuse(color = "gray10")
)
```
